...
<div class="max-w-2xl">
	...
	<form method="POST" use:enhance>
		<div class="card mb-4">
			<div class="card-header"><span class="font-semibold text-sm text-gray-700">PO Details</span></div>
			<div class="card-body grid grid-cols-2 gap-4">
				<div>
					<label class="form-label">PO Number</label>
					<input type="text" name="po_number" class="form-input" required placeholder="e.g. 54321" />
				</div>
				<div>

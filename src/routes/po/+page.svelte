...
<div class="card">
	<div class="card-header"><span class="text-sm font-semibold text-amber-700">Overdue</span></div>
	<table class="w-full text-sm">
		...
		<tr class="border-b border-gray-50 hover:bg-gray-50">
			<td class="px-4 py-2 font-medium"><a href="/po/{po.id}" class="text-blue-700 hover:underline">{po.po_number}</a></td>
			<td class="px-4 py-2 text-amber-600">{fmtDate(po.expected_date)}</td>
			<td class="px-4 py-2 text-right"><a href="/po/{po.id}/receive" class="btn-primary btn-sm">Receive</a></td>
		</tr>
		{/each}
		</tbody>
	</table>
...
<div class="card">
	<div class="card-header"><span class="text-sm font-semibold text-gray-700">Upcoming</span></div>
	...
	<table class="w-full text-sm">
		...
		<tr class="border-b border-gray-50 hover:bg-gray-50">
			<td class="px-4 py-2"><a href="/po/{po.id}" class="font-medium text-blue-700 hover:underline">{po.po_number}</a></td>
